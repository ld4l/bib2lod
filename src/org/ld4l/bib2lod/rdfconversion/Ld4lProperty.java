...
public enum Ld4lProperty {
    ...
    CONTINUED_UNDER_NEW_TITLE_BY("continuedUnderNewTitleBy"),
    CONTINUES_UNDER_NEW_TITLE("continuesUnderNewTitle"),
    DATE(OntNamespace.DCTERMS, "date"),
    DEATHDATE(OntNamespace.SCHEMA, "deathDate"),
    DIMENSIONS("dimensions"),
    EXTENT("extent"),
    FOLLOWS("follows"),
    HAS_ABSORBED("hasAbsorbed"),
    ...
    HAS_OTHER_EDITION("hasOtherEdition"),
    ...
    HAS_SOURCE_STATUS("hasSourceStatus"),
