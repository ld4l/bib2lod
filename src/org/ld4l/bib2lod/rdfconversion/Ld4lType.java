...
public enum Ld4lType {
    ...
    AUDIO("Audio"),
    AUTHOR_CONTRIBUTION("AuthorContribution", "Author Contribution"),
    CARTOGRAPHY("Cartography"),
    CLASSIFICATION("Classification"),
    CODEN("Coden"),
    COLLECTION("Collection"),
    COMPOSER_CONTRIBUTION("ComposerContribution", "Composer Contribution"),
    CONDUCTOR_CONTRIBUTION("ConductorContribution", "Conductor Contribution"),
    CONFERENCE("Conference"),
    CONTRIBUTION("Contribution", "Contribution"),
    CREATOR_CONTRIBUTION("CreatorContribution", "Creator Contribution"),
    DATASET("Dataset"),
    DATE(OntNamespace.DC, "date"),
    DDC_SHELF_MARK("DdcShelfMark"),
    DISSERTATION_IDENTIFIER("DissertationIdentifier"),
    DISTRIBUTOR_PROVISION("DistributorProvision", "Distributor Provision"),
    DOI("Doi"),
    EAN("Ean"),
    EDITOR_CONTRIBUTION("EditorContribution", "Editor Contribution"),
    ...
    MANUFACTURER_PROVISION("ManufacturerProvision", "Manufacturer Provision"),
    ...
    NARRATOR_CONTRIBUTION("NarratorContribution", "Narrator Contribution"),
    NBAN("Nban"),
    NBN("Nbn"),
    ...
    PERFORMER_CONTRIBUTION("PerformerContribution", "Performer Contribution"),
    PERSON(OntNamespace.FOAF, "Person"),
    PLACE(OntNamespace.PROV, "Location"),
    POLICY_SET("PolicySet"),
    POSTAL_REGISTRATION_NUMBER("PostalRegistrationNumber"),
    PRINT("Print"),
    PRODUCER_PROVISION("ProducerProvision", "Producer Provision"),
    PROVISION("Provision", "Provision"),
    PUBLISHER_NUMBER("PublisherNumber"),
    PUBLISHER_PROVISION("PublisherProvision", "Publisher Provision"),
    SERIAL("Serial"),
